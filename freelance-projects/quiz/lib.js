...
c.canvas.width  = window.innerHeight / 0.5626;
...
class TextBox {
    ...
    draw() {
        var x = this.rect[0]+this.offset[0],
            ...
            h = this.rect[3];
        // wrapping logic here
        c.font = this.textSize+'px Orbitron';
        ...
        for(var k in newLines){
            c.textAlign = "center";
            c.fillText(newLines[k], this.rect[0]+this.rect[2]/2, y+(k*this.textSize*1.2));
        }
        c.restore()
    }
}
...
function showText(text, X, Y, Size, colour = "rgb(0, 0, 0)", bold = false, stroke = false, fnt = "Orbitron", align = 'center'){
	c.save();
	c.beginPath();
	if(bold === true){
...
// audio shit
let sfx = {
    select: new Howl({src:["./assets/select.mp3"], volume:2}),
    click: new Howl({src:["./assets/click.mp3"], volume:0.7}),
    fail: new Howl({src:["./assets/fail.wav"], volume:0.4}),
    error: new Howl({src:["./assets/error.wav"], volume:0.4}),

    // animals
    pig: new Howl({src:["./assets/pig.wav"], volume:0.35}),
    owl: new Howl({src:["./assets/owl.wav"], volume:0.35}),
    frog: new Howl({src:["./assets/frog.wav"], volume:0.35}),
    snake: new Howl({src:["./assets/snake.wav"], volume:0.35}),
    kookaburra: new Howl({src:["./assets/kookaburra.wav"], volume:0.35}),
    siren: new Howl({src:["./assets/siren.mp3"], volume:0.5}),
}
